...
post = {
    ...
    "agência": '0001',
    "saldo": 3000,
    "tags": ["cliente1", "fabio", "corrente", "pf", "adulto", "masculino"],
...
new_posts = [{
    ...
    "agência": '0001',
    "saldo": 2000,
    "tags": ["cliente2", "bruno", "corrente", "pf", "adulto", "feminino"],
    "date": datetime.datetime.utcnow()
},
    {
    "author": "Cliente3 Carlos",
    ...
    "agência": '0001',
    "saldo": 10000,
    "tags": ["cliente3", "carlos", "corrente", "pj", "empresa", "adulto", "masculino"],
    "date": datetime.datetime.utcnow()
},
    {
    "author": "Cliente4 Fabio",
    ...
    "agência": '0001',
    "saldo": 500,
    "tags": ["cliente4", "fabio", "poupanca", "pf", "crianca", "feminino"],
    "date": datetime.datetime.utcnow()
}]
